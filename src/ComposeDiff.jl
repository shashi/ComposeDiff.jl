...
# Redraw everytime
Compose.isfinished(backend::Patchable) = false
...
function Compose.push_property_frame(img::Patchable, properties)
...
Compose.iswithjs(::Patchable) = false
Compose.iswithousjs(::Patchable) = true
...
function Compose.finish(img::Patchable)
...
Compose.root_box(img::Patchable) =
